    ...
    return (
        <div className="document-search">
            ...
            <p className="security-notice">
                🔒 SECURE: This search implements access control and only returns documents you have permission to view. 
                All queries are sanitized and validated for security.
            </p>
                ...
                <div className="search-options">
                    ...
                    <div className="form-group">
                        <label className="checkbox-label">
                            ...
                            />
                            Include Private Documents (Your own documents only)
                        </label>
                    </div>
                </div>
                            ...
                            <div key={doc.id} className={`result-item ${doc.is_private ? 'private' : 'public'}`}>
                                ...
                                <div className="result-actions">
                                    <button
                                        ...
                                        title="Delete document (Authorization required)"
                                    >
                                        Delete
                                    </button>
                                </div>
